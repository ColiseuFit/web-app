...
export default function WeeklyResultsList({ results, formatDisplayName }: WeeklyResultsListProps) {
  if (results.length === 0) {
    return (
      <div style={{ 
        padding: "48px 24px", 
            ...
            <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "6px", marginTop: "6px", flexWrap: "wrap" }}>
                ...
                <span style={{ 
                  ...
                  <span>{aluno.wods_completed} WODS</span>
                </span>
                ...
                <span style={{
                  ...
                  <span>{aluno.total_points} PTS</span>
                </span>
              </div>
            </div>
          </div>
