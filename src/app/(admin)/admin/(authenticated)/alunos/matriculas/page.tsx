...
import TurmasClient from "../../turmas/TurmasClient";
import { getCoaches } from "../../gestao/professores/actions";
import { getHolidays } from "../../turmas/actions";
  ...
  if (slotsError) {
    return (
      <div className="admin-container-fluid">
        <h1 style={{ fontSize: "32px", fontWeight: 800, margin: "0 0 8px" }}>Matrículas</h1>
